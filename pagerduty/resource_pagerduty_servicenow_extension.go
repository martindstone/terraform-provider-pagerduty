...
type PagerDutyServiceNowExtensionConfig struct {
...
func resourcePagerDutyServiceNowExtension() *schema.Resource {
	return &schema.Resource{
		Create: resourcePagerDutyServiceNowExtensionCreate,
		Read:   resourcePagerDutyServiceNowExtensionRead,
		Update: resourcePagerDutyServiceNowExtensionUpdate,
		Delete: resourcePagerDutyServiceNowExtensionDelete,
		Importer: &schema.ResourceImporter{
			State: resourcePagerDutyServiceNowExtensionImport,
		},
...
func buildServiceNowExtensionStruct(d *schema.ResourceData) *pagerduty.Extension {
	...
	var config = &PagerDutyServiceNowExtensionConfig{
...
func resourcePagerDutyServiceNowExtensionCreate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*pagerduty.Client)

	extension := buildServiceNowExtensionStruct(d)
	...
	return resourcePagerDutyServiceNowExtensionRead(d, meta)
}

func resourcePagerDutyServiceNowExtensionRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*pagerduty.Client)
	...
	return resource.Retry(2*time.Minute, func() *resource.RetryError {
		...
		if err := d.Set("extension_objects", flattenServiceNowExtensionObjects(extension.ExtensionObjects)); err != nil {
		...
		var config = new(PagerDutyServiceNowExtensionConfig)
...
func resourcePagerDutyServiceNowExtensionUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*pagerduty.Client)
...
func resourcePagerDutyServiceNowExtensionDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*pagerduty.Client)
...
func resourcePagerDutyServiceNowExtensionImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
	client := meta.(*pagerduty.Client)
...
func flattenServiceNowExtensionObjects(serviceList []*pagerduty.ServiceReference) interface{} {
